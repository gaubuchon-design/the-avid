  ...
  return (
    ...
    >
      ...
      <div style={S.faderWrap}>
        ...
        />
        <div style={S.dbReadout}>{gainToDb(track.gain)} dB</div>
      </div>
      ...
      <input
        ...
        style={S.panSlider}
        title={`Pan: ${track.pan > 0 ? `R${Math.round(track.pan * 100)}` : track.pan < 0 ? `L${Math.round(Math.abs(track.pan) * 100)}` : 'C'}`}
      />

      {/* M / S buttons */}
      <div style={S.msBtnRow}>
        <button
...
function MasterStrip() {
  ...
  return (
    <div style={{ ...S.strip(true), borderColor: 'var(--brand-dim)' }}>
      ...
      <div style={S.faderWrap}>
        ...
        />
        <div style={S.dbReadout}>{gainToDb(masterGain)} dB</div>
      </div>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={S.mixerGrid}>
        ...
        <div style={{ width: 1, background: 'var(--border-default)', alignSelf: 'stretch', flexShrink: 0, margin: '0 4px' }} />
        <MasterStrip />
      </div>
      <div style={S.lufsSection}>
...
function EQCurveCanvas({ track }: { track: AudioTrackState }) {
          ...
          <div key={i}>
            ...
            <div style={S.eqRow}>
              ...
              <input
                ...
                style={S.eqSlider}
              />
              <span style={S.eqValue}>{formatHz(band.frequency)} Hz</span>
            </div>
            {/* Gain */}
            <div style={S.eqRow}>
              ...
              <input
                ...
                style={S.eqSlider}
              />
              <span style={S.eqValue}>{band.gain > 0 ? '+' : ''}{band.gain.toFixed(1)} dB</span>
            </div>
            {/* Q */}
            <div style={S.eqRow}>
              ...
              <input
                ...
                style={S.eqSlider}
              />
              <span style={S.eqValue}>{band.Q.toFixed(1)}</span>
            </div>
          </div>
        ))}
      </div>
...
function TransferCurveCanvas({
  ...
  return <canvas ref={canvasRef} style={S.dynCanvas} />;
}
        ...
        {[
          ...
          <div key={ctrl.label} style={S.dynRow}>
            ...
            <input
              ...
              style={S.dynSlider}
            />
            <span style={S.dynValue}>{ctrl.defaultVal}{ctrl.unit}</span>
          </div>
        ))}
      </div>
    </div>
